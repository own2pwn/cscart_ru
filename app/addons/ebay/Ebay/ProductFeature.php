...
class ProductFeature
{
    ...
    public function getValue()
    {
        ...
        } elseif ($this->type == ProductFeatures::TEXT_SELECTBOX || $this->type == ProductFeatures::EXTENDED) {
            $variant = reset($this->selected_variants);

            if ($variant) {
                $result = $variant->name;
            }
        } elseif ($this->type == ProductFeatures::NUMBER_SELECTBOX || $this->type == ProductFeatures::NUMBER_FIELD) {
