        ...
        foreach ($order_data['products'] as $product) {
            ...
            if (!empty($product['product_options']) && $export_options == 'Y') {
                ...
                foreach ($product['product_options'] as $option_value) {
                    $combination = $option_value['option_id'] . '_' . $option_value['value'] . '_';
                ...
                $options_inventory = db_get_row("SELECT external_id, combination_hash FROM ?:product_options_inventory WHERE product_id = ?i AND combination = ?s", $product['product_id'], $combination);
