...
if (defined('PAYMENT_NOTIFICATION')) {
    ...
    $order_total = fn_format_price_by_currency($order_info['total'], CART_PRIMARY_CURRENCY, 'RUB');
...
function fn_payment_rbk_get_hash($order_id, $request)
{
    ...
    $hash_data = array(
        ...
        fn_format_price_by_currency($order_info['total'], CART_PRIMARY_CURRENCY, 'RUB'),
