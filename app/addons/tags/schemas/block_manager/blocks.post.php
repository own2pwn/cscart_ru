...
if (!isset($schema['main']['cache_overrides_by_dispatch']['pages.view']['request_handlers'])) {
    $schema['main']['cache_overrides_by_dispatch']['pages.view']['request_handlers'][] = 'page_id';
}
$schema['main']['cache_overrides_by_dispatch']['pages.view']['update_handlers'][] = 'tags';
$schema['main']['cache_overrides_by_dispatch']['pages.view']['update_handlers'][] = 'tag_links';
