<div id="content_yml">
    ...
    <div id="acc_general" class="collapse in">
        ...
        <div class="control-group">
            ...
            <div class="controls"><input type="text" name="product_data[yml2_seller_warranty]" id="yml2_expiry" size="55" value="{$product_data.yml2_expiry}" class="input-text-large" />
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}</div>
        </div>
