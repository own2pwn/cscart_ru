        ...
        {hook name="products:view_main_info"}
            {if $product}
                ...
                {hook name="products:quick_view_image_wrap"}
                    {if !$no_images}
                        <div class="ty-product-block__img cm-reload-{$obj_prefix}{$obj_id}" id="product_images_{$obj_prefix}{$obj_id}_update" style="width:{$thumbnail_width|default:$thumbnail_height}px; height: {$thumbnail_height|default:$thumbnail_width}px;">
