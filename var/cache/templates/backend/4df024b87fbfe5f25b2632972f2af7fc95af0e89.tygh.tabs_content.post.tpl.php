<?php /* Smarty version Smarty-3.1.21, created on 2016-06-17 16:42:30
         compiled from "/var/www/html/cscart_ru_i/design/backend/templates/addons/yml_export/hooks/products/tabs_content.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5303647745763fe468541e3-55095385%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4df024b87fbfe5f25b2632972f2af7fc95af0e89' => 
    array (
      0 => '/var/www/html/cscart_ru_i/design/backend/templates/addons/yml_export/hooks/products/tabs_content.post.tpl',
      1 => 1466167673,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5303647745763fe468541e3-55095385',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5763fe46a4d706_53210981',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5763fe46a4d706_53210981')) {function content_5763fe46a4d706_53210981($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/cscart_ru_i/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_modifier_in_array')) include '/var/www/html/cscart_ru_i/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
fn_preload_lang_vars(array('general','yml2_offer_type','tt_addons_yml_export_hooks_products_tabs_content_post_yml2_offer_type','yml_export.yml2_exclude_export','yml2_brand','yml2_model','yml2_type_prefix','yml2_sales_notes','yml2_country','yml2_manufacturer_warranty','tt_addons_yml_export_hooks_products_tabs_content_post_yml2_manufacturer_warranty','yml2_seller_warranty','tt_addons_yml_export_hooks_products_tabs_content_post_yml2_seller_warranty','yml2_expiry','tt_addons_yml_export_hooks_products_tabs_content_post_yml2_expiry','yml2_bid','yml2_cbid','yml2_purchase_price','yml2_adult','yml2_false','yml2_true','shipping','yml2_delivery','yml2_true','yml2_false','yml2_store','yml2_true','yml2_false','yml2_pickup','yml2_true','yml2_false'));
?>
<div id="content_yml">
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_yml_export_hooks_products_tabs_content_post_yml2_offer_type")), 0);?>
:</label>
...
echo $_smarty_tpl->__('yml_export.category_value',array('[default]'=>__($_smarty_tpl->tpl_vars['yml2_parent_offer_type_name']->value)));
} else {
...
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_brand]" id="yml2_brand" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_brand'], ENT_QUOTES, 'UTF-8');?>
...
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_model]" id="yml2_model" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_model'], ENT_QUOTES, 'UTF-8');?>
...
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_type_prefix]" id="yml2_type_prefix" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_type_prefix'], ENT_QUOTES, 'UTF-8');?>
...
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_sales_notes]" id="yml2_sales_notes" size="50" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_sales_notes'], ENT_QUOTES, 'UTF-8');?>
" class="input-text-large" />
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'product','name'=>"update_all_vendors[product]"), 0);?>
</div>
        </div>
...
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_origin_country]" id="yml2_country" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_origin_country'], ENT_QUOTES, 'UTF-8');?>
" class="input-text-large" />
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'product','name'=>"update_all_vendors[product]"), 0);?>
</div>
        </div>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_yml_export_hooks_products_tabs_content_post_yml2_manufacturer_warranty")), 0);?>
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_manufacturer_warranty]" id="yml2_manufacturer_warranty" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_manufacturer_warranty'], ENT_QUOTES, 'UTF-8');?>
" class="input-text-large" />
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'product','name'=>"update_all_vendors[product]"), 0);?>
</div>
        </div>
        ...
        <div class="control-group">
            <label for="yml2_seller_warranty" class="control-label"><?php echo $_smarty_tpl->__("yml2_seller_warranty");
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_yml_export_hooks_products_tabs_content_post_yml2_seller_warranty")), 0);?>
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_seller_warranty]" id="yml2_seller_warranty" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_seller_warranty'], ENT_QUOTES, 'UTF-8');?>
" class="input-text-large" />
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'product','name'=>"update_all_vendors[product]"), 0);?>
</div>
        </div>
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>__("tt_addons_yml_export_hooks_products_tabs_content_post_yml2_expiry")), 0);?>
:</label>
            <div class="controls"><input type="text" name="product_data[yml2_seller_warranty]" id="yml2_expiry" size="55" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_data']->value['yml2_expiry'], ENT_QUOTES, 'UTF-8');?>
" class="input-text-large" />
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'product','name'=>"update_all_vendors[product]"), 0);?>
</div>
        </div>
...
:</label>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>__("shipping"),'target'=>"#acc_shipping"), 0);?>
