<?php /* Smarty version Smarty-3.1.21, created on 2016-06-17 16:42:27
         compiled from "/var/www/html/cscart_ru_i/design/backend/templates/views/products/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2911047125763fe43cc5d26-28006297%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86bc30db5e411bc162429bd5f8b84fe4ecc2e569' => 
    array (
      0 => '/var/www/html/cscart_ru_i/design/backend/templates/views/products/update.tpl',
      1 => 1466167677,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2911047125763fe43cc5d26-28006297',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5763fe443326f0_82535593',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5763fe443326f0_82535593')) {function content_5763fe443326f0_82535593($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/cscart_ru_i/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_math')) include '/var/www/html/cscart_ru_i/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
if (!is_callable('smarty_modifier_enum')) include '/var/www/html/cscart_ru_i/app/functions/smarty_plugins/modifier.enum.php';
                    ...
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:update_tools_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:update_tools_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['view_uri']->value) {?>
                                ...
                                <li class="divider"></li>
                            <?php }?>
                            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("clone"),'href'=>"products.clone?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value),'method'=>"POST"));?>
</li>
                            <?php if ($_smarty_tpl->tpl_vars['allow_save']->value) {?>
                                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm",'href'=>"products.delete?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value),'method'=>"POST"));?>
</li>
                            <?php }?>
