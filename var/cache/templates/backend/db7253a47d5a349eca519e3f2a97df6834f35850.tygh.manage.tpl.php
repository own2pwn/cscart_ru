<?php /* Smarty version Smarty-3.1.21, created on 2016-06-17 16:53:40
         compiled from "/var/www/html/cscart_ru_i/design/backend/templates/views/languages/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1980054457576400e40d7438-29626733%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'db7253a47d5a349eca519e3f2a97df6834f35850' => 
    array (
      0 => '/var/www/html/cscart_ru_i/design/backend/templates/views/languages/manage.tpl',
      1 => 1466167676,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1980054457576400e40d7438-29626733',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_576400e42b2663_36085760',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_576400e42b2663_36085760')) {function content_576400e42b2663_36085760($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/cscart_ru_i/app/functions/smarty_plugins/block.hook.php';
                            ...
                            <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"languages:list_extra_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"languages:list_extra_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['language']->value['lang_code']!=@constant('DEFAULT_LANGUAGE')) {?>
                                        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm",'text'=>__("delete"),'href'=>"languages.delete_language?lang_id=".((string)$_smarty_tpl->tpl_vars['language']->value['lang_id']),'method'=>"POST"));?>
</li>
                                    <?php }?>

                                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-language-name",'text'=>__("clone"),'href'=>"languages.clone_language?lang_id=".((string)$_smarty_tpl->tpl_vars['language']->value['lang_id']),'method'=>"POST"));?>
</li>
                                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("export"),'href'=>"languages.export_language?lang_id=".((string)$_smarty_tpl->tpl_vars['language']->value['lang_id']),'method'=>"POST"));?>
</li>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    ...
    <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
        <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"add_language",'text'=>__("new_language"),'title'=>__("add_language"),'content'=>Smarty::$_smarty_vars['capture']['add_language'],'act'=>"general",'icon'=>"icon-plus",'link_class'=>"cm-dialog-auto-size"), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"languages:manage_tools_list")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"languages:manage_tools_list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("on_site_live_editing"),'href'=>fn_url("customization.update_mode?type=live_editor&status=enable"),'target'=>"_blank",'method'=>"POST"));?>
</li>
            <li class="divider"></li>
