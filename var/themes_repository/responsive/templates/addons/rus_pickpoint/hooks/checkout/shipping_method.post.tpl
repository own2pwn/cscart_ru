{if $cart.chosen_shipping.$group_key == $shipping.shipping_id && $shipping.module == 'pickpoint'}
    ...
    <a class="ty-btn__secondary ty-btn" href="#" id="pickpoint_terminal" onclick="PickPoint.open(addressPostamat, { fromcity:'{$fromcity}',city:'{$pickpoint_city}' });return false">{__("addons.rus_pickpoint.select_terminal")}</a>
{/if}
